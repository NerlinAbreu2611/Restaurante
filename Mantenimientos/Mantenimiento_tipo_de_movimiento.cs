    ...
    public partial class Mantenimiento_tipo_de_movimiento : Mantenimiento
    {
        ...
        private void cargarDataGrid(List<tipo_movimiento> tipo_Movimientos)
        {
            ...
            foreach (tipo_movimiento m in tipo_Movimientos)
            {
                ...
                if (m.Estado)
                {
                    if(m.Afecta_stock == 1)
                    {
                        dataGrid.Rows.Add(m.Id, m.Descripcion, "si", Image.FromFile("C:\\Users\\elmen\\Desktop\\imagenes\\pen.png"), Image.FromFile("C:\\Users\\elmen\\Desktop\\imagenes\\eye.png"));
                    }
                    else
                    {
                        dataGrid.Rows.Add(m.Id, m.Descripcion, "no",Image.FromFile("C:\\Users\\elmen\\Desktop\\imagenes\\pen.png"), Image.FromFile("C:\\Users\\elmen\\Desktop\\imagenes\\eye.png"));
                    }
                ...
                else
                {
                    if (m.Afecta_stock == 1)
                    {
                        dataGrid.Rows.Add(m.Id, m.Descripcion, "si", Image.FromFile("C:\\Users\\elmen\\Desktop\\imagenes\\pen.png"), Image.FromFile("C:\\Users\\elmen\\Desktop\\imagenes\\hidden.png"));
                    }
                    else
                    {
                        dataGrid.Rows.Add(m.Id, m.Descripcion, "no", Image.FromFile("C:\\Users\\elmen\\Desktop\\imagenes\\pen.png"), Image.FromFile("C:\\Users\\elmen\\Desktop\\imagenes\\hidden.png"));
                    }
        ...
        private void _CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                tipo_movimiento tipo = repositorio.buscarPorId(id)[0];
